...
void avaliar_funcao(void (*multiply_func)(double **, double **, double **, int, void *, void *), int eventos[], int NUM_EVENTS,
                    double **A, double **B, double **C, int N, void *extra_data, void *extra_data2, long long *resultados, double *time)
{
...
void avaliar_funcao_com_block(void (*multiply_func)(double **, double **, double **, int, void *, void *), int eventos[], int NUM_EVENTS,
                              double **A, double **B, double **C, int N, int block_size, char *loop_order, long long *resultados, double *time)
{
  return avaliar_funcao(multiply_func, eventos, NUM_EVENTS, A, B, C, N, (void *)&block_size, (void *)loop_order, resultados, time);
}
...
void avaliar_funcao_sem_block(void (*multiply_func)(double **, double **, double **, int), int eventos[], int NUM_EVENTS,
                              double **A, double **B, double **C, int N, void *extra_data, void *extra_data2, long long *resultados, double *time)
{
  return avaliar_funcao((void (*)(double **, double **, double **, int, void *, void *))multiply_func, eventos, NUM_EVENTS, A, B, C, N, NULL, NULL, resultados, time);
}